...
@section('content')
	...
	<!--banner strat here-->
	<div class="banner" style="background-image: url({{ asset('storage/banners/') }}/{{$bannerImg}}); min-height: 600px;">
		<div class="container">
			<div class="banner-main">
				<div class="col-md-6 banner-left">
					{{-- <a href="single.html"><img src="{{ asset('storage/banners/') }}/{{$bannerImg}}" alt="" class="img-responsive"></a> --}}
				</div>
