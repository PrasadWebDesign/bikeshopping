...
<head>
<title>Home</title>
<link href="{{URL::to('/')}}/theme_assets/css/bootstrap.css" rel="stylesheet" type="text/css" media="all">
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script src="{{URL::to('/')}}/theme_assets/js/jquery-1.11.0.min.js"></script>
<!-- Custom Theme files -->
<link href="{{URL::to('/')}}/theme_assets/css/style.css" rel="stylesheet" type="text/css" media="all"/>

<link href="{{URL::to('/')}}/theme_assets/css/my_style.css" rel="stylesheet" type="text/css" media="all"/>
<!-- Custom Theme files -->
...
<script type="text/javascript" src="{{URL::to('/')}}/theme_assets/js/move-top.js"></script>
<script type="text/javascript" src="{{URL::to('/')}}/theme_assets/js/easing.js"></script>
